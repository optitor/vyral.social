...
<div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-cyan-500/10 via-blue-500/5 to-background p-8 border border-cyan-500/20 mb-8">
  <div className="relative z-10">
    <h1 className="text-4xl md:text-5xl font-bold mb-3">Liquidity Strategy and DEX Launch</h1>
    <p className="text-lg text-muted-foreground">Bootstrap plan, DEX launch criteria, and continuous growth</p>
  </div>
...
<div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-6">
  ...
  <div className="rounded-xl border border-emerald-500/50 bg-gradient-to-br from-emerald-500/15 to-emerald-500/5 p-6 shadow-lg">
    ...
    <div className="space-y-2 text-sm">
      ...
      <div className="flex justify-between items-center pt-2 border-t">
        <span className="font-bold">Reach $75K</span>
        <span className="font-mono font-bold text-lg text-emerald-500">7-8 months</span>
      </div>
      <div className="text-xs text-center text-emerald-500 mt-3 font-bold">Realistic target</div>
    </div>
  </div>
    ...
    <div className="space-y-2">
      <div className="flex items-center gap-3 p-2 rounded bg-muted/50">
        ...
        <div className="flex-1 bg-cyan-500/20 rounded-full h-2">
          <div className="bg-cyan-500 h-full rounded-full" style={{width: '6.25%'}}></div>
        </div>
      ...
      <div className="flex items-center gap-3 p-2 rounded bg-muted/50">
        ...
        <div className="flex-1 bg-cyan-500/20 rounded-full h-2">
          <div className="bg-cyan-500 h-full rounded-full" style={{width: '11.25%'}}></div>
        </div>
      ...
      <div className="flex items-center gap-3 p-2 rounded bg-muted/50">
        ...
        <div className="flex-1 bg-cyan-500/20 rounded-full h-2">
          <div className="bg-cyan-500 h-full rounded-full" style={{width: '42.5%'}}></div>
        </div>
      ...
      <div className="flex items-center gap-3 p-2 rounded bg-emerald-500/10">
        ...
        <span className="font-mono text-sm font-bold text-emerald-500">Pool reaches $300K</span>
      </div>
      <div className="flex items-center gap-3 p-2 rounded bg-primary/10 border border-primary/30">
        ...
        <span className="font-mono text-sm font-bold text-primary">Pool reaches $1M+</span>
      </div>
    </div>
  </div>
