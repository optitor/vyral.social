...
<div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-purple-500/10 via-blue-500/5 to-background p-8 border border-purple-500/20 mb-8">
  <div className="relative z-10">
    <h1 className="text-4xl md:text-5xl font-bold mb-3">Smart Contract Architecture</h1>
    <p className="text-lg text-muted-foreground">Technical implementation of VCoin token and platform contracts</p>
  </div>
...
<Callout type="info">
  All smart contract addresses are deployed on Solana devnet and can be verified on [Solana Explorer](https://explorer.solana.com).
</Callout>
...
<div className="rounded-xl border border-border bg-card p-6 my-6">
  <h3 className="text-xl font-bold mb-4">🔐 How Your VCoins Are Secured</h3>
