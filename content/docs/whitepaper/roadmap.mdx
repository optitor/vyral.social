...
<div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-cyan-500/10 via-purple-500/5 to-background p-8 border border-cyan-500/20 mb-8">
  <div className="relative z-10">
    <h1 className="text-4xl md:text-5xl font-bold mb-3">Launch Roadmap and Milestones</h1>
    <p className="text-lg text-muted-foreground">Timeline, milestones, and development phases</p>
  </div>
...
<div className="space-y-4 my-6">
  ...
  <div className="rounded-xl border border-purple-500/30 bg-gradient-to-br from-purple-500/10 to-purple-500/5 p-6">
    <div className="flex items-center justify-between mb-4">
      ...
      <div className="text-sm font-bold text-purple-500">Optimize & prepare for DEX</div>
    </div>
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
      <div className="p-3 rounded-lg bg-background border border-border text-center">
        <div className="text-2xl font-mono font-bold text-purple-500">50,000</div>
        <div className="text-xs text-muted-foreground mt-1">Users</div>
      </div>
      <div className="p-3 rounded-lg bg-background border border-border text-center">
        <div className="text-2xl font-mono font-bold text-purple-500">$100K</div>
        <div className="text-xs text-muted-foreground mt-1">Cumulative sales</div>
      </div>
      <div className="p-3 rounded-lg bg-background border border-border text-center">
        <div className="text-2xl font-mono font-bold text-purple-500">$20K</div>
        <div className="text-xs text-muted-foreground mt-1">Liquidity accumulated</div>
      </div>
      <div className="p-3 rounded-lg bg-background border border-border text-center">
        <div className="text-2xl font-mono font-bold text-purple-500">1M</div>
        <div className="text-xs text-muted-foreground mt-1">Transactions</div>
      </div>
    </div>
  </div>
...
<div className="space-y-4 my-6">
  ...
  <div className="rounded-xl border border-blue-500/30 bg-gradient-to-br from-blue-500/10 to-blue-500/5 p-6">
    <h4 className="text-xl font-bold mb-3">Month 12: Enhanced Community Feedback</h4>
  ...
  <div className="rounded-xl border border-purple-500/30 bg-gradient-to-br from-purple-500/10 to-purple-500/5 p-6">
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
      <div className="p-3 rounded-lg bg-background border border-border text-center">
        <div className="text-2xl font-mono font-bold text-purple-500">2-5M</div>
        <div className="text-xs text-muted-foreground mt-1">Total users</div>
      </div>
      <div className="p-3 rounded-lg bg-background border border-border text-center">
        <div className="text-2xl font-mono font-bold text-purple-500">$500K-2M</div>
        <div className="text-xs text-muted-foreground mt-1">Monthly revenue</div>
      </div>
      <div className="p-3 rounded-lg bg-background border border-border text-center">
        <div className="text-2xl font-mono font-bold text-purple-500">$500K+</div>
        <div className="text-xs text-muted-foreground mt-1">Liquidity pool</div>
      </div>
      <div className="p-3 rounded-lg bg-purple-500/20 border border-purple-500/40 text-center">
        <div className="font-bold text-purple-500">Sustainable</div>
        <div className="text-xs text-purple-500 mt-1">Business model</div>
      </div>
    </div>
  </div>
